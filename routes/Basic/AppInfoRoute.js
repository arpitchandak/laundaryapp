...
const Product = require('../../schema/Basic/AppInfoSchema')
const bcrypt = require('bcrypt');


router.get('/appInfo',async (req,res,next) => {
...
router.post('/appInfo',async (req,res,next) => {
    res.setHeader('Access-Control-Allow-Origin','*');
...
router.delete('/appInfo/:id',async (req,res,next) => {
    res.setHeader('Access-Control-Allow-Origin','*');
...
router.patch('/appInfo/:id',async (req,res,next) => {
    res.setHeader('Access-Control-Allow-Origin','*');
